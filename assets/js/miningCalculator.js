...
var app = (function () {
    ...
    var MultilingualContent = content[language];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function initData() {
    		fetch(`https://api.coingecko.com/api/v3/simple/price?ids=ergo&vs_currencies=USD`).then(response => {
    			if (response.ok) {
    				return response;
    			} else {
    				throw new Error();
